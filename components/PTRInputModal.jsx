const PTRInputModal = ({ isOpen, closeModal, tempPropertiesData, handleModalFormChange, handleUpdateModalFormSubmit, handleModalFormSubmit, isEdit }) => {
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      value={tempPropertiesData.dateAcquired.slice(0,10) || ""}
                      onChange={handleModalFormChange}
                    />
                  </div>
                  <div className="mb-4">
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      value={tempPropertiesData.condition || ""}
                      onChange={handleModalFormChange}
                      min={0}
                    />
                  </div>
